...
// OAuth device-flow client identifier registered for this CLI on the
// ThinRemote OAuth provider. Stable across versions.
const OAUTH_CLIENT_ID = '3b40164d28730e416cbd';

// Hard ceiling on how long to keep polling for the user to finish the
// device-code flow in the browser before we give up (10 minutes).
const OAUTH_DEVICE_CODE_TIMEOUT_MS = 10 * 60 * 1000;
...
async function authenticateWithOAuth() {
    ...
    console.log(
        chalk.blue('Press ' + chalk.bold('ENTER')) +
    ...
    console.log(chalk.green('OAuth token validation successful\n'));
}

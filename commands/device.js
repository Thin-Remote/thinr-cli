...
/**
 * `thinr devices` — top-level listing across all accessible devices.
 */
...
/**
 * `thinr device <subcommand> <deviceId> …` — all device-scoped actions as
 * proper Commander subcommands. Each subcommand declares `<deviceId>` as
 * its first positional so help, option parsing and validation are
 * autogenerated per-action.
 */
